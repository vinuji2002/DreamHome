...
$sql = "SELECT * FROM registered_user WHERE Username = '$username' AND Password = '$password'";
...
<html>
<head>
    <title>Dream Home | User Login</title>
...
<body style="background-color: black;">
    ...
    <center>
        <div class="background">
            <div class="container">
                <div class="title"><i class="fa-solid fa-user"></i> Login</div>
                <form action="" method="POST">
                    <div class="user-details">
                        ...
                        <div class="button">
                            <input type="button" value="Admin Login" onclick="window.location.href='adminlog.php';">
                        </div>
                    </div>
                </form>
