...
<head>
    ...
    <title>Dream Home | Admin Registration</title>
...
<div class="container">
    <div class="title"><i class="fa-solid fa-user-plus"></i> Admin User Registration</div>
            <form action="aduregister.php" method="POST">
